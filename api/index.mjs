...
app.post("/api/auth/forgot-password", passwordResetLimiter, async (req, res) => {
    ...
    try {
        ...
        // 1. PFAD ZUM LOGO ERMITTELN & VALIDIEREN
            ...
            <div class="container">
                ...
                <div class="content">
                    ...
                    <div class="link-alt">
                        ...
                        <span style="color: #9333ea;">${frontend_url}/reset-password?oobCode=${oobCode}&apiKey=${apiKey}&lang=de</span>
                    </div>
                </div>
                <div class="footer">
